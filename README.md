...
Over time, it evolved into a space where I intentionally challenged myself to answer one question:

How far can pure HTML & CSS really go?

No frameworks.
No JavaScript.
Just HTML, CSS, creativity, and patience.
...
Click the file above to watch the screen recording directly.
